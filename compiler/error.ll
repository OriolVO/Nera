...
@.str.0 = private unnamed_addr constant [11 x i8] c"IO Error: \00", align 1
@.str.1 = private unnamed_addr constant [31 x i8] c"Syntax Error (see diagnostics)\00", align 1
@.str.2 = private unnamed_addr constant [33 x i8] c"Semantic Error (see diagnostics)\00", align 1
@.str.3 = private unnamed_addr constant [16 x i8] c"Backend Error: \00", align 1
...
define i8* @compile_error_to_string(i64** noalias %param_err) {
entry:
  %shared_vec_idx = alloca i64
  %ptr_span = alloca i64**
  %ptr_message = alloca i8*
  ...
  %ptr_value = alloca i8*
  %ptr_val = alloca i64
  store i64** %param_err, i64*** %ptr_err
  %1 = load i64**, i64*** %ptr_err
  %2 = bitcast i64** %1 to i64*
  %3 = load i64, i64* %2
  ...
  %7 = icmp eq i64 %6, 0
  br i1 %7, label %when_case_1, label %when_next_2
when_case_1:
  %8 = inttoptr i64 %3 to i64*
  %9 = getelementptr inbounds i64, i64* %8, i64 1
  %10 = bitcast i64* %9 to i8**
  %11 = load i8*, i8** %10, align 8
  %12 = call i8* @concat_strings(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.0, i64 0, i64 0), i8* %11)
  ret i8* %12
unreachable_3:
  br label %when_end_0
when_next_2:
  %13 = icmp eq i64 %6, 1
  br i1 %13, label %when_case_4, label %when_next_5
when_case_4:
  ret i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.1, i64 0, i64 0)
unreachable_6:
  br label %when_end_0
when_next_5:
  %14 = icmp eq i64 %6, 2
  br i1 %14, label %when_case_7, label %when_next_8
when_case_7:
  ret i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2, i64 0, i64 0)
unreachable_9:
  br label %when_end_0
when_next_8:
  %15 = icmp eq i64 %6, 3
  br i1 %15, label %when_case_10, label %when_next_11
when_case_10:
  ...
  store i8* %19, i8* %11
  %20 = call i8* @concat_strings(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.3, i64 0, i64 0), i8* %11)
  ret i8* %20
unreachable_12:
  br label %when_end_0
when_next_11:
