...
when_next_14:
  %21 = icmp eq i64 %5, 7
  br i1 %21, label %when_case_16, label %when_next_17
when_case_16:
  br label %when_end_0
when_next_17:
  %22 = icmp eq i64 %5, 8
  br i1 %22, label %when_case_18, label %when_next_19
when_case_18:
  br label %when_end_0
when_next_19:
  %23 = icmp eq i64 %5, 9
  br i1 %23, label %when_case_20, label %when_next_21
when_case_20:
  br label %when_end_0
when_next_21:
  %24 = icmp eq i64 %5, 10
...
when_next_23:
  %25 = icmp eq i64 %5, 11
  br i1 %25, label %when_case_24, label %when_next_25
when_case_24:
  br label %when_end_0
when_next_25:
  br label %when_end_0
...
entry:
  ...
  store i64* %4, i64*** %ptr_global_scope
  %5 = load i64**, i64*** %ptr_global_scope
  %6 = bitcast i64** %5 to i64*
  %7 = getelementptr inbounds i64, i64* %6, i64 0
  %8 = bitcast i64* %7 to i8**
  store i8* null, i8** %8, align 8
  %9 = load i64**, i64*** %ptr_global_scope
  %10 = bitcast i64** %9 to i64*
  %11 = getelementptr inbounds i64, i64* %10, i64 1
  %12 = bitcast i64* %11 to i8**
  store i8* null, i8** %12, align 8
  %13 = load i64**, i64*** %ptr_env
  %14 = load i64**, i64*** %ptr_global_scope
  %15 = bitcast i64** %13 to i64*
  %16 = getelementptr inbounds i64, i64* %15, i64 0
  %17 = bitcast i64* %16 to i64***
  store i64** %14, i64*** %17, align 8
  %18 = load i64**, i64*** %ptr_env
  ret i64** %18
unreachable_0:
  ret i64** null
}
