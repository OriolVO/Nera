...
@.str.6 = private unnamed_addr constant [4 x i8] c"let\00", align 1
@.str.7 = private unnamed_addr constant [4 x i8] c"mut\00", align 1
...
@.str.13 = private unnamed_addr constant [21 x i8] c"Unexpected character\00", align 1
...
while_end_142:
  ...
  %488 = call i32 @strcmp(i8* %487, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.6, i64 0, i64 0))
...
end_if_144:
  ...
  %497 = call i32 @strcmp(i8* %496, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.7, i64 0, i64 0))
...
end_if_147:
  ...
  %506 = call i32 @strcmp(i8* %505, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.8, i64 0, i64 0))
...
end_if_150:
  ...
  %515 = call i32 @strcmp(i8* %514, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.9, i64 0, i64 0))
...
end_if_153:
  ...
  %524 = call i32 @strcmp(i8* %523, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.10, i64 0, i64 0))
...
end_if_156:
  ...
  %533 = call i32 @strcmp(i8* %532, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.11, i64 0, i64 0))
...
end_if_159:
  ...
  %542 = call i32 @strcmp(i8* %541, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.12, i64 0, i64 0))
...
unreachable_163:
  br label %end_if_162
end_if_162:
  %550 = call i8* @malloc(i64 16)
  %551 = bitcast i8* %550 to i64*
  %552 = getelementptr inbounds i64, i64* %551, i64 0
  store i64 25, i64* %552
  %553 = load i8*, i8** %ptr_ident
  ...
  %558 = call i64** @make_token(i64* %551, i64 %556, i64 %557)
  ret i64** %558
unreachable_164:
  br label %end_if_139
end_if_139:
  %559 = load i64, i64* %ptr_c
  %560 = call i1 @is_digit(i64 %559)
  br i1 %560, label %then_165, label %end_if_166
then_165:
  %561 = load i64, i64* %ptr_c
  %562 = sub nsw i64 %561, 48
  store i64 %562, i64* %ptr_val
  br label %while_cond_167
while_cond_167:
  %563 = load i64**, i64*** %ptr_lex
  %564 = call i64 @peek(i64** %563)
  %565 = call i1 @is_digit(i64 %564)
  br i1 %565, label %while_body_168, label %while_end_169
while_body_168:
  %566 = load i64**, i64*** %ptr_lex
  %567 = call i64 @advance(i64** %566)
  store i64 %567, i64* %ptr_next_c
  %568 = load i64, i64* %ptr_val
  %569 = mul nsw i64 %568, 10
  %570 = load i64, i64* %ptr_next_c
  %571 = sub nsw i64 %570, 48
  %572 = add nsw i64 %569, %571
  store i64 %572, i64* %ptr_val
  br label %while_cond_167
while_end_169:
  %573 = call i8* @malloc(i64 16)
  %574 = bitcast i8* %573 to i64*
  %575 = getelementptr inbounds i64, i64* %574, i64 0
  store i64 26, i64* %575
  %576 = load i64, i64* %ptr_val
  %577 = getelementptr inbounds i64, i64* %574, i64 1
  %578 = bitcast i64* %577 to i64*
  store i64 %576, i64* %578
  %579 = load i64, i64* %ptr_start_line
  %580 = load i64, i64* %ptr_start_col
  %581 = call i64** @make_token(i64* %574, i64 %579, i64 %580)
  ret i64** %581
unreachable_170:
  br label %end_if_166
end_if_166:
  %582 = call i8* @malloc(i64 16)
  %583 = bitcast i8* %582 to i64*
  %584 = getelementptr inbounds i64, i64* %583, i64 0
  store i64 63, i64* %584
  %585 = getelementptr inbounds i64, i64* %583, i64 1
  %586 = bitcast i64* %585 to i8**
  store i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.13, i64 0, i64 0), i8** %586
  %587 = load i64, i64* %ptr_start_line
  %588 = load i64, i64* %ptr_start_col
  %589 = call i64** @make_token(i64* %583, i64 %587, i64 %588)
  ret i64** %589
unreachable_171:
  ret i64** null
}
