...
impl<'a> SemanticAnalyzer<'a> {
    ...
    fn analyze_expression(&mut self, expr: &mut Spanned<Expression>) -> TypeInfo {
        ...
        match &mut expr.node {
            ...
            Expression::VariantConstruct(_) => {
                TypeInfo::Unknown
            }
            Expression::StructFieldAccess(_) => {
                // This node is generated by sema itself during PropertyAccess analysis.
                // If we encounter it again, we can just return its known type.
                TypeInfo::Unknown
            }
